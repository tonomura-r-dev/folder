...
PLANS = [
    ...
    },
    {
        ...
        "title": "冬コミ・同人誌",
        "aim": (
            "推し活・同人・トレカ関連URLのクリック者だけに配信する。BtoB層に同人の話を"
            "送るとブロックされるため、分けること自体が目的。冬コミの入稿ピーク前に"
            "先回りして枠を押さえる。"
        ),
        "purpose": "CV獲得",
        "target": "BtoC・同人作家・クリエイター（Meta広告流入層）",
        "audience": "推し活／同人／トレカ／うちわ のURLクリック者",
        "banner": (
            "トレカ台紙バナーの路線（ピンク×パープル、キラキラ、ポップ）。同人誌の実物写真＋"
            "「表紙PP加工」などの仕様バッジ。「1種類1冊から」を必ず入れる。下部CTA帯。"
        ),
        "text": (
            "冬コミの本、いつ入稿しますか。\n\n"
            "12月直前は混み合うので、\n"
        ...
        "note": "※最小ロットと加工オプションを要確認",
        "url": f"{BASE}/lineup/doujinshi-all/",
        "campaign": "20260925_message_WinterComike",
    },
    {
        "no": 28,
        "date": "2026/09/29",
