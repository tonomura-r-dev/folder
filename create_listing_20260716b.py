...
# 第150弾（2026-07-16b）美容クリニックチェーン・LP URLはサービスページ優先

data_0716b = [
    ["医療法人社団元輝会", "https://taclinic.jp/reservation/", "", "美容整形・美容外科・美容皮膚科（TAクリニック）", "美容整形 全国, 二重整形 名医, 美容外科 カウンセリング", "美容クリニックチェーン"],
]

base = r"C:\Users\tonomura-r\Downloads\との\新しいフォルダー"
make_xlsx(f"{base}\\架電リスト_Meta_2026-07-16b.xlsx", data_0716b)
