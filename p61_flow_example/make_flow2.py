...
# ---- Frame 1: サイトでの注文完了（変更なし、少しだけスマホ感を出す枠に）----
img1 = Image.new("RGB", (W, H), "#FFFFFF")
d1 = ImageDraw.Draw(img1)
d1.rounded_rectangle((6, 6, W-6, H-6), radius=16, outline="#DADFE3", width=2)
...
# ---- Frame 2: ロック画面プッシュ通知（差し替え）----
img2 = Image.new("RGB", (W, H), "#2B2E36")
d2 = ImageDraw.Draw(img2)
d2.rounded_rectangle((6, 6, W-6, H-6), radius=16, outline="#3A3E47", width=2)
# faux lock screen clock
d2.text((W/2-46, 60), "18:02", font=font(46, True), fill="#FFFFFF")
d2.text((W/2-44, 112), "2026年7月2日（木）", font=font(13), fill="#CBCBCB")

# push notification banner
nb = (24, 170, W-24, 170+96)
d2.rounded_rectangle(nb, radius=18, fill="#3A3D45")
# app icon
d2.rounded_rectangle((nb[0]+14, nb[1]+14, nb[0]+14+32, nb[1]+14+32), radius=8, fill=LINE_GREEN)
d2.text((nb[0]+24, nb[1]+20), "L", font=font(18, True), fill="#FFFFFF")
d2.text((nb[0]+58, nb[1]+12), "ハコブーン", font=font(12, True), fill="#FFFFFF")
d2.text((nb[2]-52, nb[1]+12), "いま", font=font(10), fill="#AAAAAA")
d2.text((nb[0]+58, nb[1]+32), "お荷物お届けのお知らせ", font=font(12, True), fill="#FFFFFF")
body2 = ["ご注文の商品を本日18時〜20時に", "お届け予定です。"]
yy = nb[1]+52
for line in body2:
    d2.text((nb[0]+58, yy), line, font=font(11), fill="#D8D8D8")
    yy += 18

d2.text((10, H-28), "② ロック画面にプッシュ通知が届く（未タップ）", font=font(11, True), fill="#8FD8B0")
img2.save("flow2_notify.png")

# ---- Frame 3: タップして開く（変更なし）----
img3 = Image.new("RGB", (W, H), "#FFFFFF")
d3 = ImageDraw.Draw(img3)
d3.rounded_rectangle((6, 6, W-6, H-6), radius=16, outline="#DADFE3", width=2)
y = 40
